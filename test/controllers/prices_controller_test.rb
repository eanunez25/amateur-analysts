...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { buyprice: @price.buyprice, equity_id: @price.equity_id, user_id: @price.user_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { buyprice: @price.buyprice, equity_id: @price.equity_id, user_id: @price.user_id } }
